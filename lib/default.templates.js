...
var defaultTemplates = function (propp) {
  ...
  propp["func1"].templates.push(
    "He left in the night without saying good-bye.  It was the night a thousand ghosts whispered in the wind, and the trees rustled and shook outside our small wooden house.  On that night, I knelt and prayed before I climbed into bed.  I fell asleep wishing the ghosts would tire and the trees would stiffen, wishing the night would let me rest.  I awoke with the sun the next morning, happy for a new day.  I awoke, hearing my mother's sobbing.  Sobbing.  For, on that night of a thousand ghosts, my father had fallen into a slumber from which he would never awaken. ",
  );
  propp["func1"].templates.push(
  ...
  propp["func2"].templates.push(
    "'To follow that path into the mountains is to walk into the hands of death.'  Day and night, my mother warns me.  She is afraid I will follow my brother who went to the mountains seeking a better life and never returned. ",
  );
  propp["func2"].templates.push(
    "The woman placed a smooth, black stone in my hand and moved my fingers to clasp it.  She told me that the stone would protect me, and warned me never to enter the woods without first securing it in my hand. ",
  );
  propp["func2"].templates.push(
    "The wind blew urgent whispers in my ears: 'Do not walk farther.  Turn around,' it whispered, 'turn around.' ",
  );
  propp["func2"].templates.push(
    "His watery eyes shone fiercely, his wrinkled mouth opened to reveal the series of gaps and crooked stained stones that were his teeth.  'Children who enter these woods never return,' he cackled, pointing a bony finger towards the dark trees. ",
  );

  // Violation of Interdiction
  propp["func3"].templates.push(
  ...
  propp["func5"].templates.push(
    "I told them that the good graces gave me whatever I had.",
  );
  propp["func5"].templates.push(
    "I told a million answers to their biting quess to silence them.",
  );
  propp["func5"].templates.push(
  ...
  propp["func8a"].templates.push(
    "There was a hopelessness that permeated my world, emanating from my skin, soaking into all my organs.  My stomach no longer bothered to call atten to itself.  Instead, it swallowed its growls, seeking nourishment in emptiness.",
  );
  ...
  propp["func14"].templates.push(
    "When I placed the needle I had taken on my palm, it moved in the direc where I needed to go.  The bones taken from the ground shielded me from any harm.",
  );
  propp["func14"].templates.push(
  ...
  propp["func15"].templates.push(
    "As I closed my eyes I could hear my father's voice guide me along the hidden pathways of the mountain unbeknownst to boys who sit and watch the sun rise and fall in their beds.",
  );
  ...
  propp["func26"].templates.push(
    "Without hesitance I lifted my pant legs began to dance in father's leather bottomed shoes.  The soles breezed across the floor, cutting the mist with rhythmic mos.  I then turned the ring on my finger and watched my father rise, soil shedding from his skin.  His shaved face and clean hands stood against the paling crowd. This impressed the people who stood before me, as did the fact that my tongue did not bleed from the needle it held.",
  );
  ...
  propp["func29"].templates.push(
    "Mother licked fingers and placed them to my face, wiping the thick layer of dirt away.  Then I truly began to look like my father's son, in form, face, and color.",
  );

  propp["func30"].templates.push(
