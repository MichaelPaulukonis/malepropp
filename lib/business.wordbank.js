var businessbank = function (words) {
  ...
  var ascension = [
    "is made CEO",
    "is made CFO",
    "is given a corner office",
    "becomes chair of the board",
    "gets keys to the executive washroom",
  ];

  var marries = [
    "is promoted",
    "has parking tickets forgiven",
    "works hard for a few years, then decides that consulting is the right career move",
    "given a reserved parking space",
  ];
  ...
  var greetings = {
    ...
    bad: [
      ...
      "Oh, hello,",
      "Well, well, well.",
      "I see you somehow managed to stay employed.",
    ],
  };
  var magicalitems = [
    "Worlds Best PowerPoint Presentation",
    "Shiny Laser Pointer",
  ];
