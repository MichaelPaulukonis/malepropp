var defaultbank = function (words) {
  ...
  var ascension = [
    ...
    "{{is}} given keys to the city",
    "{{has}} parking tickets forgiven",
  ];

  var marries = [
    "{{marry}}",
    "{{dates}} for a few years, but {{decides}} to remain single",
  ];
