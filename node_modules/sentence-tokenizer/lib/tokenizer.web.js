...
// does not actually appear to be a dependency
// var debug = require('debug')('tokenizer');

// cheap web-or-node wrapper.
// place reference to sugar.min.js in the htm
// and only use THIS file for web; use REAL tokenizer in node.js
