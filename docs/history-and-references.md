# History, design notes, and references

Moved out of README.md during cleanup — dev-diary musings, prior-art surveys, and external research links, none of which are needed to run/test/understand the current code. See the main [README](../README.md) for that.
